...
export const products: ProductProps[] = [
  {
    ...
    description: "This is a fantastic ODS 2024 T-Shirt with a unique design.",
    reviews: [
      { author: "John Doe", content: "Great fit and comfortable!" },
      { author: "Jane Smith", content: "Love the design and quality." },
      {
        author: "Mike Johnson",
        content: "Excellent product, worth the price.",
      },
      { author: "Emily Brown", content: "The material is top-notch." },
      { author: "Chris Davis", content: "Fast shipping and great packaging." },
      { author: "Alex Turner", content: "Satisfied with the purchase." },
      {
        author: "Sophia White",
        content: "Unique style, received many compliments.",
      },
      { author: "John Doe", content: "Great fit and comfortable!" },
      { author: "Jane Smith", content: "Love the design and quality." },
      {
