export const OrderMail = `<!DOCTYPE html>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 145.067px;"><img src="https://037177b9f8.imgdist.com/pub/bfra/y4xcobdy/fyx/4j2/kt1/logo.svg" style="display: block; height: auto; border: 0; width: 100%;" width="145.067" alt="Company Logo" title="Company Logo"></div>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="15" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 374px;"><img src="https://037177b9f8.imgdist.com/pub/bfra/y4xcobdy/77s/l9c/3gk/shopping-online-drop-shipping-6691014.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="374" alt="Resetting Password" title="Resetting Password"></div>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="heading_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="text-align:center;width:100%;">
																<h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32.4px;"><span class="tinyMce-placeholder">Dear {{name}}</span></h1>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:10px;">
																<div style="color:#848484;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:180%;text-align:center;mso-line-height-alt:25.2px;">
																	<p style="margin: 0; word-break: break-word;"><span>your order has been confirmed and will be shipped in 30days.</span></p>
																	<p style="margin: 0; word-break: break-word;"><span>Thank You for shopping with us</span></p>
																</div>
															</td>
														</tr>
													</table>
