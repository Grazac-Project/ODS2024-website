...
const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        " max-[500px]:py-2   px-4 sm:px-8 xl:px-10 2xl:px-20 flex w-full justify-between items-center  transition-colors duration-500",
        scrollHeight > 200
      ...
      <div className="hidden lg:flex items-center gap-x-5 lg:gap-x-7 2xl:gap-x-10 w-full justify-center max-w-[50%] 2xl:max-w-[40%]">
        <Link
          ...
          className={cn(
            ...
            isActive === "" ? "before:w-full text-primary" : "text-header"
          )}
        >
          Home
        </Link>
