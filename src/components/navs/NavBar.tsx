  ...
  return (
    <nav
      ...
      className={cn(
        ...
        " max-[500px]:py-1 px-4 sm:px-8 xl:px-10 2xl:px-20 w-full justify-between items-center bg-white transition-colors duration-500",
        scrollHeight > 200
          ? " fixed backdrop-blur-xl top-0 left-0  z-50 -translate-y-28 opacity-0 animate-slideDown bg-white/90 py-1 border-b border-gray-200 shadow-md"
          : "sm:py-6 py-4",
        {
          "bg-white ": scrollHeight > 800 && scrollHeight < 4300,
        }
      )}
    >
